...
import { LayoutDashboard, Newspaper, FolderOpen, Inbox, Package, LogOut, ExternalLink, Palette, Images, Globe, FileText, Calculator, Tag, Search } from "lucide-react";
...
const menu = [
  ...
  { href: "/admin/tu-khoa", label: "Từ khoá Google", icon: Search },
  { href: "/admin/tinh-cuoc", label: "Lượt tính cước", icon: Calculator },
